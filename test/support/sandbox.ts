...
export type SandboxRunner = 'vitest' | 'jest' | 'node-test' | 'pytest'
...
/**
 * A throwaway Vitest, Jest, node:test or pytest project driven through the real Veyrum CLI. Lives under the
